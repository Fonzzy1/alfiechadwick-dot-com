...
We can also see here some impact of being released early in the year, 



```{R plays vs Success , echo = FALSE}

plays_marge_results <- combined_results %>%
     merge( combined_plays)
