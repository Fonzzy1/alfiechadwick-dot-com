...
My only gripe with the theme is that it uses a default list for all types of content. If you want to look at all the posts, you see a list of posts; for categories, similarly, you get a list of categories.
